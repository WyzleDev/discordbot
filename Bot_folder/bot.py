...
status = ['Love some mama', 'WWW____WWW!', 'tiny secret']
queue = []
...
async def hello(ctx):
    responses = ['**Darova brat**', '**4e kavo?**', '**Salam!**']
...
@client.command(name="kick", help='This command kicks user from the server')
async def kick(ctx, member: discord.Member, *, reason=None):
    await member.kick(reason=reason)


@client.command(name='ban', help='this command bans user from the server')
